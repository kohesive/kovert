...
class TestRendering: AbstractKovertTest() {
    ...
    @Test fun testAnnotatedRenderMethods() {
        val controller = MockController1()
        _router.bindController(controller, "/view")

        _client.testServer(HttpMethod.GET, "/view/test/mock/view1", assertResponse = """mocked:1 -- [test.mock1] -- Model1(name=Fred, age=33)""", assertContentType = "text/html")
    ...
    @Test fun testDynamicRenderMethods() {
        ...
        _client.testServer(HttpMethod.GET, "/view/test/returned/mock/view1", assertResponse = """mocked:1 -- [test.mock1] -- Model1(name=David, age=20)""", assertContentType = "text/html")
        _client.testServer(HttpMethod.GET, "/view/test/returned/mock/view2", assertResponse = """mocked:1 -- [test.mock1] -- Model1(name=David, age=20)""", assertContentType = "text/html")
    }

    @Test fun testBadEngineSelectionInAnnotation() {
        val controller = MockController1()
        _router.bindController(controller, "/view")

        _client.testServer(HttpMethod.GET, "/view/test/bad/engine1", 404) // it will not exist, logged as error on binding time
    }

    @Test fun testBadEngineSelectionDynamically() {
        val controller = MockController1()
        _router.bindController(controller, "/view")
    ...
    @Test fun testContentTypeOverriding() {
        val controller = MockController1()
        _router.bindController(controller, "/view")

        _client.testServer(HttpMethod.GET, "/view/test/mock/view1/and/content/type/override", assertResponse = """mocked:1 -- [test.mock1] -- Model1(name=Danny, age=99)""", assertContentType = "overriden/type")
        _client.testServer(HttpMethod.GET, "/view/test/mock/view2/and/content/type/from/engine", assertResponse = """mocked:2 -- [test.mock2] -- Model1(name=Danny, age=99)""", assertContentType = "xhtml")
        _client.testServer(HttpMethod.GET, "/view/test/mock/view2/and/content/type/from/engine/overridden", assertResponse = """mocked:2 -- [test.mock2] -- Model1(name=Danny, age=99)""", assertContentType = "overriden/type2")
